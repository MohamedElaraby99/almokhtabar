      ...
      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
        ...
        <div className="px-6 pb-4">
          <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
            ...
            {isOpen && (
              <div className="mt-4 flex items-center gap-2 text-sm text-[#5b2233] dark:text-blue-400">
    ...
    <div className="space-y-4">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#5b2233] focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
        />
        {searchTerm && (
          ...
          {filteredItems.length > 4 && (
            <div className="text-center pt-4">
              <button
                ...
                className="inline-flex items-center gap-2 text-[#5b2233] dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors duration-200"
              >
                {showAll ? (
                  <>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
